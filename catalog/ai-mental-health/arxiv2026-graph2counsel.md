---
name: UKPLab/arxiv2026-graph2counsel
url: https://github.com/UKPLab/arxiv2026-graph2counsel
...
rating: 5
status: active
tags: [synthetic-data, counseling, knowledge-graph]
summary: 基于客户心理图谱（CPG）生成结构化、临床落地的合成咨询对话
---
...
| **Star 数** | 搜索时未显示具体数值（学术项目，截至 2026-07） |
| **Fork 数** | 同上 |
