---
name: Chips98/CoPoLLM-for-ACL-2026
url: https://github.com/Chips98/CoPoLLM-for-ACL-2026
...
rating: 4
status: active
tags: [rl, llm, cognitive-distortion]
summary: RL+LLM 融合检测与干预情绪支持对话中的认知扭曲（ACL 2026）
---
...
| **论文发表** | ACL 2026 |
| **开源许可** | MIT License |
| **Star 数** | 搜索时未显示具体数值（新项目，截至 2026-07） |
| **Fork 数** | 同上 |
