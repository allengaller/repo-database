---
name: dosanko-tousan/Gemini-Abhidhamma-Alignment
url: https://github.com/dosanko-tousan/Gemini-Abhidhamma-Alignment
domain: mind-philosophy
type: tool
languages: []
stars: 3
forks: 0
...
rating: 3
status: active
tags: [prompt-engineering, abhidhamma, gemini]
summary: 阿毗达磨 × Gemini 的减法对齐 prompt 框架（含中文 System Prompt 移植）
---
...
- **缺乏量化评估**：3 stars（截至 2026-07）、0 forks，几乎没有社区验证。压力测试为轶事性质。
