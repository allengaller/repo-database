...
const I18N = {
  zh: {
    ...
    "qs2": "检票 · 本地浏览 UI",
    "qs3": "建档 · 生成档案草稿",
    "qsNote": "想要在线版本？Fork 后在 Settings → Pages 选择 GitHub Actions，再加一个发布 web/ 的静态站点 workflow 即可上线——这座车站随时可以复制。",
  ...
  en: {
    ...
    "qsNote": "Want it hosted? Fork, choose GitHub Actions under Settings → Pages, and add your own workflow that publishes web/ — this station is built to be copied.",
    "termLine": "本次列车终点：你的下一个好仓库。",
    "ctaStar2": "Star repo-database",
